...
public class StrandSort {
    ...
    public static void main(String[] args){
        System.out.println(strandSort(new LinkedList<>(Arrays.asList(3, 1, 2, 4, 5))));
        System.out.println(strandSort(new LinkedList<>(Arrays.asList(3, 3, 1, 2, 4, 5))));
        System.out.println(strandSort(new LinkedList<>(Arrays.asList(3, 3, 1, 2, 4, 3, 5, 6))));
    }
}
